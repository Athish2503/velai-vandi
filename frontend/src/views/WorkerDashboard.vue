<template>
  <div class="max-w-3xl mx-auto my-10 p-4">
    <div class="flex items-center justify-between mb-8">
      <div>
        <h1 class="text-3xl font-extrabold text-[#4b4b4b]">Top Job Matches</h1>
        <p class="text-gray-500 font-bold mt-1">Here are the best jobs based on your skills and location.</p>
      </div>
    ...
    <div v-if="loading" class="text-center py-20">
      <div class="inline-block w-12 h-12 border-4 border-t-[#58cc02] border-[#e5e5e5] rounded-full animate-spin"></div>
      <p class="mt-4 font-bold text-gray-400">Finding perfect matches...</p>
    </div>

    <div v-else-if="matches.length === 0" class="text-center py-20 card">
      <span class="text-5xl mb-4 block opacity-50">😢</span>
      <h3 class="text-xl font-bold text-gray-600">No matches found yet</h3>
      <p class="text-gray-400 font-medium">Try adding more skills to your profile.</p>
    </div>
